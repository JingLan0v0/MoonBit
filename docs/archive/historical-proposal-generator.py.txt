...
section("05  交付与计划", "交付核心库、CLI、README、示例、测试、许可证、架构/API/限制说明和固定工具链。公开仓库已同步，干净源码复现与 Linux CI 已通过。2026-09-21 已形成候选版本，计划 9 月 28 日前准备最终验收材料，并根据官方反馈补件。")
para("当前状态：报名、入群、官方审核及支持发放仍待确认。姓名和联系方式由参赛者在正式报名表中填写。", small, 0)
